...
Reason: text workflows and the local Web preview can now reuse uniquely matched prepared `.gcode` / `.nc` files from `LASER_PREPARED_GCODE_DIR` without bypassing confirmation gates.
