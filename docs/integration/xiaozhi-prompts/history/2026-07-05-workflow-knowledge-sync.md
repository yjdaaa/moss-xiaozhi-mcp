# Xiaozhi/MOSS Console Prompt Snapshot - 2026-07-05

Reason: sync knowledge-base text so “帮我刻 xxx” routes through `laser_workflow_tool` preview before any send path.
